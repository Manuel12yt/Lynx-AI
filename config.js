...
global.textbot = `Lynx - AI`
global.listo = '*Aqui tiene ฅ^•ﻌ•^ฅ*'
global.namechannel = 'The Lynx - AI 🌠'
global.baileys = "@whiskeysockets/baileys"

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
global.catalogo = fs.readFileSync('./logos/LynxAI.png')
global.miniurl = fs.readFileSync('./logos/LynxAI.png')
global.imagen1 = fs.readFileSync('./logos/LynxAI.png')

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
global.group = 'https://chat.whatsapp.com/'
global.canal = 'https://whatsapp.com/channel/0029Vaxb5xr7z4koGtOAAc1Q'
global.imagen2 = 'https://i.ibb.co/R6xxwRn/LynxAI.png';
global.icono = 'https://i.ibb.co/R6xxwRn/LynxAI.png';
...
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*j
